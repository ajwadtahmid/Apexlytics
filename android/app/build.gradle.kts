...
plugins {
    ...
    // Kotlin is provided by AGP 9's built-in Kotlin support (android.builtInKotlin=true
    // in gradle.properties) instead of applying the standalone Kotlin Gradle Plugin.
